...
function renderHeader(active){
  ...
  return '<div id="gp-topbar" class="promo-bar">Bienvenue chez GearPlay — <strong>-10 %</strong> sur votre première commande avec le code <strong>GEARPLAY10</strong></div>'+
  '<div id="gp-header"><div class="gp-nav">'+
  '<a href="index.html" class="gp-logo"><span class="gp-logo-icon"><svg width="19" height="19" viewBox="0 0 24 24" fill="none"><path d="M7 8h10a4 4 0 0 1 4 4v0a4 4 0 0 1-4 4c-1.4 0-2.2-.7-3-1.5S12.8 17 12 17s-1.2-1-2-1.5S8.4 16 7 16a4 4 0 0 1-4-4v0a4 4 0 0 1 4-4Z" stroke="var(--cta-fg)" stroke-width="1.7"/><circle cx="8" cy="12" r="1.3" fill="var(--cta-fg)"/><path d="M15.6 11.2v1.6M14.8 12h1.6" stroke="var(--cta-fg)" stroke-width="1.3" stroke-linecap="round"/></svg></span><span class="gp-logo-text clash">Gear<span>Play</span></span></a>'+
...
function renderFooter(){
  ...
  '<div><a href="index.html" style="text-decoration:none"><span class="clash gp-logo-text">Gear<span>Play</span></span></a><p style="font:400 13.5px/1.6 Inter;color:var(--text2);margin:12px 0 0;max-width:260px">Boutique française de high-tech et gaming neuf. Livraison 24-48h partout en France métropolitaine.</p>'+
  ...
  '</div><div class="footer-bottom"><div class="footer-bottom-inner"><span>© 2026 GearPlay Store SAS · SIRET 902 456 781 00025 · TVA FR90 902456781</span><span style="display:flex;gap:16px"><a href="mentions-legales.html">Mentions légales</a><a href="cgv.html">CGV</a><a href="confidentialite.html">Confidentialité</a></span></div></div></footer>';
}
